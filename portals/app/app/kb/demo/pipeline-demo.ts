...
export const DEMO_TASKS: TasksData = {
  ...
  tiers: [
    { key: "interactive", label: "interactive · 上传 / Entry / Agent 沉淀", queued: 3, concurrency: "2 并发", pct: 12 },
    { key: "sync", label: "sync · Arda 增量", queued: 21, concurrency: "2 并发", pct: 34 },
