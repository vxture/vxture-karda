...
const PROBES: Record<string, unknown[]> = {
  ...
  "common.pagerCount": [42],
  "common.itemCount": [5],
  "shell.docsCount": [7],
  "assets.coverageAria": [82],
  "assets.openAsset": ["Bid library"],
  "assets.lifeIngestBindings": [2],
  "assets.lifeParked": [3],
  "assets.lifeVerifyNote": [40, 52],
  "assets.lifeServeTop": ["forge · anlan"],
  "assets.vectorLocked": ["bge-m3"],
  "assets.okVectorLocked": ["bge-m3"],
  "assets.bindRevokedSuffix": [2],
  "assets.verifiedBy": ["usr_a1b2"],
  "assets.knowledgeTitle": ["Bid library"],
  "assets.knowledgeMeta": [27, 12, 8],
  "assets.kCapped": [2000],
  "assets.kDiscardBulkTarget": [3],
  "assets.kConflictsTitle": [2],
  "assets.kAdoptConsequence": [2],
  "assets.kAssertedBy": ["GB 25201-2010"],
  "assets.kAsOf": ["2026/08/01"],
  "assets.kValidUntil": ["2027/08/01"],
  "assets.kSourceOf": ["Fire code", 3],
  "assets.okKConfirm": [5],
  "assets.okKConfirmPartial": [3, 2],
  "assets.okKDiscard": [2],
  "assets.okKAdopt": [1],
  "assets.uploadToFolder": ["Bid 2026"],
  "assets.docPageCount": [238],
  "assets.docPageCountFiltered": [50, 238],
  "assets.lifeExtractNote": [44],
  "assets.lifeExtractPending": [12],
